...
export const { getLocation, getAction, getHash, getSearch, getMatchedRoutes, getMatch, getMatchParam, createMatchSelector } = /*#__PURE__*/ createSelectors(plainStructure)
