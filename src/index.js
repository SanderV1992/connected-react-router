...
export const { getLocation, getLocationState, getLocationStateParam, getAction, getHash, getSearch, getMatchedRoutes, getMatch, getMatchParam, createMatchSelector } = /*#__PURE__*/ createSelectors(plainStructure)
