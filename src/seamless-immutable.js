...
export const { getLocation, getAction, getHash, getSearch, getMatchedRoutes, getMatch, getMatchParams, createMatchSelector } = /*#__PURE__*/ createSelectors(immutableStructure)
